  ...
  return (
    <div className="innerWidth">
      <div className="flex justify-around mt-10">
        <a
          href="#"
          class="pl-8 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-900"
        >
          <img
            class="mr-10 object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
          ...
          <div class="flex flex-col justify-between p-4 leading-normal">
            ...
            <button className="bg-green-600 text-white mt-2 py-2 px-4 rounded-full shadow-md hover:bg-green-700 transition duration-300">
              Buy Now
            </button>
          </div>
        </a>
