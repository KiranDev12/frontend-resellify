    ...
    <>
      <div className="grid innerWidth grid-flow-col grid-cols-2 container mx-auto p-8 text-center">
        ...
        <div>
          ...
          <p className="text-lg mb-4">
            ...
            access to 5,000+ products from 300+ certified merchants, we're
            shaping the future of online marketplaces.
          </p>

          <p className="text-lg mb-4">
            Your Stuff, Your Store: Resellify is the Next-Gen Marketplace
            designed for resellers of all levels. Whether you're just starting
            or an experienced seller, we provide the tools and platform you need
            to succeed.
          </p>

          <p className="text-lg mb-4">
            Explore a curated selection of high-quality products and create a
            personalized store that reflects your style. Join us in redefining
      ...
      {/* <div className="innerWidth flex flex-col ">
        <div className="flex mb-4">
          <span className="primaryText text-center">Similar products</span>
        </div>
        <div className="innerWidth flex justify-around">
          <SimilarProduct
